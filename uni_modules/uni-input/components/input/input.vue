...
<script setup lang="uts">
	...
	const placeholderStyle = computed(() => {
		// const styleFontSize = style.get('font-size') as string
		// if(styleFontSize){
		// 	if(styleFontSize.unit == 2){
		// 		return `font-size:${styleFontSize.value}px;${props.placeholderStyle}`
		// 	}
		// }
