...
void RecycleList::setElement(Element *element) {
    ...
    auto height = HPNodeLayoutGetHeight(scrollLayoutNode);
    auto paddingTop = HPNodeLayoutGetPadding(scrollLayoutNode, CSSDirection::CSSTop);
    auto paddingBottom = HPNodeLayoutGetPadding(scrollLayoutNode, CSSDirection::CSSBottom);
...
void RecycleList::setListHeaderElement(Element *element) {
    ...
    auto size = HPNodeLayoutGetHeight(this->listHeaderElement->GetLayoutNode());
...
void RecycleList::onScrollStart() {
    ...
    this->scrollElement->document()->GetPage()->setRecycling(true);
};
...
void RecycleList::onScrollEnd() {
    ...
    this->scrollElement->document()->GetPage()->setRecycling(false);
...
void RecycleListItem::initSize() {
    ...
    auto size = HPNodeLayoutGetHeight(this->viewElement->GetLayoutNode());
    if (std::isnan(size)) {
...
void RecycleListItem::translate(float offset) {
    ...
    if (nativeView) {
        ...
        auto page = static_cast<uniappx::harmony::HMPage *>(this->viewElement->document()->GetPage());
